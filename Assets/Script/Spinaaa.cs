...
public class Spinaaa : MonoBehaviour
{
    ...
    private void Update()
    {
        okButton.onClick.AddListener(Offpanel);
                            
    }
    public void Offpanel()
    {
        OKPan.SetActive(false);
    }    
    public void StartSpin()
    {
        ...
        if(totalruby > 15)
        {
            ...
            totalruby -= 15;
            totalrubyText.text = (totalruby).ToString();
        ...
        {
            textCooldown.text = "Bạn không đủ ruby";
        }    
    }
    ...
    IEnumerator SpinCoroutine()
    {
        while (currentSpeed > 0)
        {
            ...
            if (currentSpeed<=0) OKPan.SetActive(true);
